...
GYRO_TARGET_DEG = 1200.0
FREE_RUN_FINISH_SECONDS = 2.0
OBSTACLE_RUN_FINISH_SECONDS = 2.0
...
class GyroThreeLapController:
    ...
    def __init__(self, drive_mode: str):
        ...
        print(
            ...
            f"stop after {GYRO_TARGET_DEG:.0f} degrees plus "
...
if __name__ == "__main__":
    ...
    print(
        f"manage26V16 starting | gyro target: {GYRO_TARGET_DEG:.0f} degrees",
        flush=True,
    )
